...
namespace LostGen
{
    ...
    public struct Point : IEquatable<Point>
    {
        ...
        public static bool WithinBox(Point point, Point upper) {
            return WithinBox(point, Point.Zero, upper);
        }
        ...
        public static Point UpperBound(params Point[] points) {
            return UpperBound(points);
        }
